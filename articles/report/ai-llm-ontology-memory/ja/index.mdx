...
<SourceNote>RAGは [Lewis et al. (2020)](https://arxiv.org/abs/2005.11401)、REALMは [Guu et al. (2020)](https://proceedings.mlr.press/v119/guu20a.html)。ここでは、検索拡張を「文書検索」だけで終わらせず、業務オブジェクト・状態・行為まで広げる必要があるという実務上の含意として引用している。</SourceNote>
