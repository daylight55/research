...
<SourceNote>RAG の原点は [Lewis et al., 2020](https://arxiv.org/abs/2005.11401)。Graphiti の hybrid search は、graph retrieval と semantic search を併用する設計として文書化されている [Graphiti overview](https://help.getzep.com/graphiti/graphiti/overview)。ここでの「RAG を置き換えない」は実務設計上の推論である。</SourceNote>
