...
```mermaid
flowchart TD
  A["Practice<br/>Judgment and discomfort"] --> B["Observation<br/>Record clues"]
  B --> C["Narrative<br/>Own words"]
  C --> D["Dialogue<br/>Probe reasons"]
  D --> E["Tentative formalization<br/>Steps and principles"]
  E --> F["Field validation<br/>Exceptions and counterexamples"]
  F -. update .-> B
```
...
```mermaid
flowchart TD
  S["Socialization: shared experience"] --> E["Externalization: metaphor and dialogue"]
  E --> C["Combination: documents and systematization"]
  C --> I["Internalization: practice and training"]
  I --> S
```
...
```mermaid
flowchart TD
  P["Target work"] --> C["Real cases"]
  C --> A["Observation and interviews"]
  A --> K["Knowledge assets<br/>Cases and procedures"]
  K --> AI["AI support<br/>Search and training"]
  AI --> V["Field validation"]
  V -. update .-> A
```
