...
6. Is foreign exchange intervention a temporary stabilization measure, or is it being talked about as an alternative to interest rate policy?
   If you read them in this order, you can break down arguments such as "Should interest rates be raised?", "Is a weak yen bad?" and "Is a wage increase a cause of inflation?" by separating pros and cons from the route being emphasized.
