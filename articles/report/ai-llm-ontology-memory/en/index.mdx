...
Source note: RAG is [Lewis et al. (2020)](https://arxiv.org/abs/2005.11401), REALM is [Guu et al. (2020)](https://proceedings.mlr.press/v119/guu20a.html). Here, it is cited as a practical implication that search expansion needs to be expanded to include business objects, states, and actions, not just "document search."
