...
| EU                                 | European Commission, Council, Member States             | Ukraine Facility, EUMAM, support loans, macro-financial support                                                            | Fiscal agreement, alignment among Member States, transport and production capacity      |
| United States                      | Executive Branch, Congress, Department of Defense       | Direct military support, arms sales, allied procurement support, information and training support                          | Domestic production priority, Congressional politics, inventory and production capacity |
...
The latest report from the Department of Defense estimates that by March 31, 2026, direct U.S. assistance will amount to $67.8 billion, and security assistance to NATO allies and partners will amount to approximately $130 billion. The full alliance contribution matters alongside the aid provided by the United States alone. Source note: [DoD / OAR report](https://media.defense.gov/2026/Apr/01/2003695701/-1/-1/0/US-DIRECT-ASSISTANCE-TO-UKRAINE-THROUGH-MARCH-31-2026.PDF).
...
The UK's strength lies in the operational continuity of training and provision, rather than the annual amount itself. Britain gains effectiveness through continuous deployment and human training rather than short-lived headline packages. Source note: [UK government factsheet](https://www.gov.uk/government/publications/uk-support-for-ukraine-factsheet/uk-support-for-ukraine-factsheet).
...
For this reason, evaluating France requires questions about spending, European consensus building, and whether it created a nexus for joint production and the defense industry. Source note: [Elysée security guarantees statement](https://www.elysee.fr/en/emmanuel-macron/2026/01/06/robust-security-guarantees-for-a-solid-and-lasting-peace-in-ukraine).
...
## 14. Support Evaluation and Export-Control Points

For Japanese policymakers, export-control officials, and supply-chain teams, the points to watch are clear.
