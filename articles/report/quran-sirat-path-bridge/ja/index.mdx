...
概念として読むなら、シラートは「正しい道を知っているか」だけでなく、「その道を日々保ち続けるか」を問う概念である。礼拝で繰り返される『開端章』の祈り、倫理的な分岐、共同体の規範、死後の責任が一つの比喩軸に乗る。だからシラートは、単なる終末怪奇譚ではなく、イスラム思想における導き、服従、自由意思、責任、救済を結びつける装置として読むべきである。
