...
7. The recommended frame is to treat LLMs as `asymmetric components of language games`: their outputs can function as meaningful moves, but responsibility and normative assessment remain with humans and institutions.
