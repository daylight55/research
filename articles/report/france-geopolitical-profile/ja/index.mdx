...
ここで重要なのは、戦略的自律が反米主義ではなく、欧州が自前の選択肢を増やす発想だという点である。フランスは核抑止と遠征能力を持つが、弾薬、ミサイル防衛、衛星、調達、東欧防衛では同盟国との連携が欠かせない。
...
フランス経済は、低成長、高い公的債務、強い社会支出、航空宇宙・防衛・農業・高級品・原子力の産業基盤を同時に抱える。IMFは2026年の実質GDP成長率を0.9%とし、欧州委員会は2026年の政府赤字をGDP比5.1%程度と見込む。<SourceNote>[IMF DataMapper, France real GDP growth](https://www.imf.org/external/datamapper/NGDP_RPCH@WEO/FRA) と [European Commission, Economic forecast for France](https://economy-finance.ec.europa.eu/economic-surveillance-eu-member-states/country-pages-including-country-reports/france/economic-forecast-france_en) を参照した。</SourceNote>
...
日本にとってフランスは、EU規制の形成国であり、インド太平洋の領土保有国であり、ウクライナ支援と防衛産業で欧州の意思決定を動かす相手である。同時に、国内政治が分裂しているため、首脳間合意だけで政策の実装を予測すると外しやすい。
