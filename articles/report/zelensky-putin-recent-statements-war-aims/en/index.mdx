...
```mermaid
flowchart LR
    Z[Zelensky] --> Z1[War of defense]
    Z --> Z2[Start from a ceasefire]
    P[Putin] --> P1[War of achievement]
    P --> P2[Press security demands]
    Z1 --> Z3[Messaging to supporters]
    P1 --> P3[Messaging for domestic consolidation]
```
