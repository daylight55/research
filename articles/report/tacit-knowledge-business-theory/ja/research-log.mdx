...
- 指定カテゴリ・slug: `knowledge-systems` / `tacit-knowledge-business-theory`
- 関連タグ: Tacit Knowledge, Knowledge Management, Wittgenstein, Generative AI
- 主要な制約: 一次情報または信頼できる公開情報を優先し、主張、根拠、限界、実務含意を分けて書く。
- 参照した記事ファイル: `articles/report/tacit-knowledge-business-theory/ja/index.mdx`
