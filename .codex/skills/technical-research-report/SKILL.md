...
- Put each topic under `research/<category>/<topic>/`.
- Treat `research/<category>/<topic>/` as the canonical location for research information in this repository. Do not put new reports directly under `research/<topic>/`.
