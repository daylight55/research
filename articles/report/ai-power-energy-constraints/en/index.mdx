...
For the United States, Lawrence Berkeley National Laboratory estimated that data centers consumed 176 TWh in 2023 and could reach 325 to 580 TWh by 2028. The EIA likewise says the strongest four-year growth in U.S. electricity demand since the early 2000s is being driven in large part by data centers and other large computing loads. The implication is not that every country will look like the U.S., but that the U.S. is the clearest stress test for the current AI load cycle. <SourceNote>[LBNL, 2024 United States Data Center Energy Usage Report](https://eta-publications.lbl.gov/sites/default/files/2024-12/lbnl-2024-united-states-data-center-energy-usage-report_1.pdf) and [U.S. EIA, electricity demand forecast 2026](https://www.eia.gov/outlooks/steo/) support this comparison.</SourceNote>
...
## 8. Practical Indicators to Watch
