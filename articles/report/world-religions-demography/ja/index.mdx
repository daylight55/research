...
このため、宗教人口は「礼拝に通う人の数」や「特定教義を信じる人の数」と一致しない。たとえば、東アジアでは宗教団体に所属しない人が、祖先祭祀、寺社参拝、民間信仰、儒教的儀礼を生活の中で続けることがある。逆に、宗教所属を持つ人の中にも、日常的な実践頻度が低い人がいる。宗教人口分布は、まず社会的・統計的な所属分布として読むのが妥当である。<SourceNote>[Pew Research Center, Measuring Religion in China](https://www.pewresearch.org/religion/2023/08/30/measuring-religion-in-china/) と [Our World in Data, Data quality and biases](https://ourworldindata.org/religion#data-quality-and-biases) は、自己申告、質問文、文化的文脈が宗教分類に影響する点を説明している。</SourceNote>
