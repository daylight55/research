...
generation:
  model: 'gpt-5.4-mini'
  promptSource: 'ops/codex/prompts/daily-issue-research.md'
  promptSummary:
    - 'GitHub Issueを調査依頼として扱い、AGENTS.mdとtechnical-research-reportに従って日本語正本の記事を作成する。'
    - '現在性が関係する情報は一次情報・信頼できる資料で確認し、重要な主張の近くにSourceNoteを置く。'
    - '日本語本文、英語本文、公開可能なresearch-log、サイト表示用frontmatterを同じ変更内で同期する。'
draft: false
---
...
| 語用論 | 発話意図、婉曲表現、含意を推測する   | 会話経験から定型のやり取りを学ぶ     | 明示された会話ルールや役割に従う |
