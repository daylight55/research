...
Source note: Useful entry points for the Strait of Hormuz and maritime logistics vulnerabilities are [World Bank, Iran overview](https://www.worldbank.org/ext/en/country/iran) and [OFAC Iran Shipping Advisory](https://ofac.treasury.gov/system/files/2025-04/Iran%20Shipping%20Advisory_4162025.pdf). The effects on Gulf countries are best understood here as "increasing uncertainty in shipping routes, insurance, and re-exports."
...
Source note: This paragraph proposes a monitoring design that integrates the published materials listed up to the previous section. This means that multiple signals should be bundled together, rather than a single statistical indicator.
