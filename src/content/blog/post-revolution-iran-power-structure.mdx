...
pubDate: '2026-05-20'
heroImage: '../../assets/images/hero/post-revolution-iran-power-structure.jpg'
...
作成日: 2026-05-20
調査方式: narrative review / institutional analysis
対象: 1979年革命後のイラン政治体制を、最高指導者、専門家会議、護憲評議会、司法、革命防衛隊、選挙制度の関係から読むこと
...
timeline
    ...
    1979 : 革命後憲法の成立。第5条と第107条で法学者の統治と専門家会議による指導者選出を制度化
    1989 : 憲法改正。単独の最高指導者と専門家会議の関係が再定義
    1990s : 専門家会議と護憲評議会の入口管理が定着
```
...
flowchart TB
    ...
    ExpertAssembly -->|選出・監督・解任| SupremeLeader
    SupremeLeader -->|法学者6名を任命| GuardianCouncil
    JudiciaryChief -->|法曹6名の候補を推薦| GuardianCouncil
    SupremeLeader -->|司法長を任命| JudiciaryChief
    SupremeLeader -->|軍の最高指揮| IRGC
    SupremeLeader -->|体制上位権限| President
    SupremeLeader -->|体制上位権限| Majles
    GuardianCouncil -->|法適合審査・候補者審査・監督| Elections
    Elections -->|大統領・議会・専門家会議を選出| President
    Elections -->|大統領・議会・専門家会議を選出| Majles
    Elections -->|大統領・議会・専門家会議を選出| ExpertAssembly
    Majles -->|制定法| GuardianCouncil
    JudiciaryChief -->|裁判体系の統括| SupremeLeader
```
