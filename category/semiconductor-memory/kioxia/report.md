...
本文では、会社概要、財務、製品仕様、上場、補助金、需給見通しに関わる主張の近くに `出典メモ:` を置く。キオクシア自身の説明は公式一次情報として扱うが、製品優位性や将来需要の表現は会社の見通しであることを明示する。市場シェアや競争状況はTrendForce等の外部調査を補助情報として使う。2026年3月期通期決算は2026-05-15 15:30 JSTに発表予定であり、本レポートは2026-05-14時点の公開情報に基づく。
