...
generation:
  ...
  promptSummary:
    - 'Treat the GitHub Issue as the research request and create the canonical Japanese report under AGENTS.md and technical-research-report rules.'
    - 'Verify time-sensitive information against primary or authoritative sources and place SourceNote citations near important claims.'
    - 'Keep the Japanese article, English article, public research log, and site frontmatter synchronized in the same change.'
draft: false
---
