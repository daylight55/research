...
<SourceNote>NPM versions checked during this research: `@playwright/mcp` `0.0.75` on May 26, 2026, `chrome-devtools-mcp` `1.1.0` on May 26, 2026, `@playwright/cli` `0.1.13` on May 7, 2026, and `@browserbasehq/mcp` `3.0.0` on March 31, 2026. See [@playwright/mcp](https://www.npmjs.com/package/@playwright/mcp), [chrome-devtools-mcp](https://www.npmjs.com/package/chrome-devtools-mcp), [@playwright/cli](https://www.npmjs.com/package/@playwright/cli), and [@browserbasehq/mcp](https://www.npmjs.com/package/@browserbasehq/mcp).</SourceNote>
