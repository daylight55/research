...
<SourceNote>SECI の基本説明は [HBR の原文](https://hbr.org/1991/11/the-knowledge-creating-company-2) と [Google Books の書誌項目](https://books.google.com/books/about/The_Knowledge_Creating_Company.html?id=pSHhzwEACAAJ) を起点にたどれる。ここでの「設計図」という表現は、公表文献からの実務上の解釈である。</SourceNote>
...
<SourceNote>LLM の事実性・忠実性の問題は、幻覚や不忠実な要約を扱う [survey](https://arxiv.org/abs/2311.05232) と、要約の品質が参照文書との整合に依存する後続研究で整理されている。ここでの「平板化」は、これらの研究を踏まえた実務上の推定であり、単一論文の直接主張ではない。</SourceNote>
