...
<SourceNote>`@playwright/mcp` の npm 最新は 2026年5月26日時点で `0.0.75`、`chrome-devtools-mcp` は同日 `1.1.0`、`@playwright/cli` は 2026年5月7日時点で `0.1.13`、`@browserbasehq/mcp` は 2026年3月31日時点で `3.0.0` と確認した。npmの [@playwright/mcp](https://www.npmjs.com/package/@playwright/mcp)、[chrome-devtools-mcp](https://www.npmjs.com/package/chrome-devtools-mcp)、[@playwright/cli](https://www.npmjs.com/package/@playwright/cli)、[@browserbasehq/mcp](https://www.npmjs.com/package/@browserbasehq/mcp) を参照。</SourceNote>
